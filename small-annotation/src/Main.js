...
export default class Main extends React.Component<Props, State> {
  ...
  show_walkthrough = () => {
    ...
    setTimeout(()=>{
      ...
      {
        element: document.querySelector('.entity_box'),
        intro: 'Drag your new span over to the correct matching entity.'
      },
      {
        element: document.querySelector('.entity_opacity'),
  ...
  get_question = (url,question_num) => {
    ...
    fetch(
      ...
      .then((res) => this.setState(
        ...
        ,()=>{this.setState({clicked: ""}); if(getCookie("token")!="" && getCookie("help")!=="done") {
        ...
        { <div> 
                  <Grid container style={{marginTop: 50}} spacing={3}>
                    ...
                    <Grid item xs={5} style={{marginLeft: "55%", paddingLeft: 25, paddingRight: 10, borderLeft:'1px solid black',height: "100%", width: "40%"}}>
                      ...
                      <button class="merge" onClick={this.show_merge} style={{marginRight: 10}}> Merge Entities </button> <button class="new" onClick={this.create_new_entity}> New Entity </button> <br />
