...
const random_topics = ['Albania', 'Hera', 'Donatello', 'Poland', 'Bystander effect', 'Ernest Hemingway', 'Spain', 'Cadmus', 'The Magic Mountain', 'The Wealth of Nations', 'Philadelphia', 'Isaac Newton', 'Germany', 'Nigeria', 'Horse', 'Neptune', 'John Stuart Mill', 'Bertrand Russell', 'Republic (Plato)', 'Mark Twain', 'Norway', 'Octavio Paz', 'Moses', 'Aeneas', 'India', 'Hades', 'Prison', 'Sparta', 'Thorstein Veblen', 'Ares', 'Boris Godunov', 'Carlos Fuentes', 'John Cage', 'Cat', 'Egypt', 'Taoism', 'Ethiopia', 'Loki', 'The Golden Bough', 'Quran', 'Gustav Mahler', 'Ra', 'John Coltrane', 'North Carolina', 'Mustafa Kemal Atatürk', 'Dionysus', 'Gottfried Wilhelm Leibniz', 'Langston Hughes', 'Messiah', 'Sweden', 'Honduras', 'Theodore Roosevelt', 'The Interpretation of Dreams', 'Maya civilization', 'Syria', 'Japan', 'Bridge', 'Bertolt Brecht', 'Huitzilopochtli', 'Baruch Spinoza', 'John Keats', 'Red', "Raoult's law", 'Odysseus', 'Indra', 'France', 'Umberto Eco', 'Iceland', 'Nicaragua', 'Charles Baudelaire', 'South Africa', 'Quebec', 'Lion', 'Philippines', 'D. H. Lawrence', 'Clarinet', 'Carthage', 'Krishna', 'Frank Gehry', 'Alan Turing', 'Equivalents', 'Ruth Benedict', 'Vietnam', 'Tanzania', 'Ganesha', 'Constantin Brâncuși', 'B. F. Skinner', 'World War I', 'Don Quixote', 'Algeria', 'Stoicism', 'Lancelot', 'Gobi Desert', 'Don Giovanni', 'Orpheus', 'Thailand', 'Pakistan', 'Canada', 'Fire', 'Belgium']
;
